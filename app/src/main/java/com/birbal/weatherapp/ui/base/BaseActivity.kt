package com.birbal.weatherapp.ui.base
...
import com.birbal.weatherapp.di.component.DaggerActivityComponent
...
abstract class BaseActivity<VM : BaseViewModel> : AppCompatActivity() {
    ...
    private fun buildActivityComponent() =
        DaggerActivityComponent
            .builder()
            .applicationComponent((application as WeatherApp).applicationComponent)
